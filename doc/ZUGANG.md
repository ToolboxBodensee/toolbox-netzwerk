...
Wenn du dich damit überhaupt nicht auskennst, findest du eine schlechte einführung dazu [auf YouTube](https://www.youtube.com/watch?v=to5jZgQWOMQ).
 ...
 ProTipp:
----------
Wir setzen auf starke Kryptografie aus eliptischen ED25519 kurven. [ED25519 auf wikipedia](https://de.wikipedia.org/wiki/Curve25519).
...
Die öffentlichen (public!) SSH Keys selber werden in dem Git Repo  [ssh-public-keys](https://gitea.see-base.de/toolbox/ssh-public-keys/) gespeichert.
...
Diese wird von jeder spezifischeren Regel überschrieben. Wenn nichts definiert ist, passt der Default, der in dieser Datei definiert ist.
